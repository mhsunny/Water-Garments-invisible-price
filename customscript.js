        ...
        scrollChange: function ($currentListItem) {
            ...
            if (currentChapter.indexOf('home') > -1) {
                ...
                $(".scroll img").css('display', 'block');
                 ...
                 $("#tableau_main_graph").html('<iframe id="viz1505283466034" style="width:600px; height: 860px;" src="http://public.tableau.com/views/GlobalShareofGarmentExportsin2014/Dashboard1?:embed=y&:showVizHome=no&:host_url=https%3A%2F%2Fpublic.tableau.com%2F&:tabs=no&:toolbar=yes&:animate_transition=yes&:display_static_image=no&display_spinner=no&:display_overlay=yes&:display_count=yes&publish=yes&:loadOrderID=0"></iframe>');
                ...
                $("#water_demand_tableau").html('<iframe frameborder="0" marginheight="0" marginwidth="0" title="data visualization" allowtransparency="true" allowfullscreen="true" class="tableauViz" style="display: block; min-width: 400px; max-width: 650px; width: 100%; height: 310px; margin: 0px; padding: 0px; border: none;" src="https://public.tableau.com/views/DailywaterdemandinDhaka/Dashboard1?:embed=y&amp;:showVizHome=no&amp;:host_url=https%3A%2F%2Fpublic.tableau.com%2F&amp;:embed_code_version=2&amp;:tabs=no&amp;:toolbar=yes&amp;:animate_transition=yes&amp;:display_static_image=no&amp;:display_spinner=no&amp;:display_overlay=yes&amp;:display_count=yes&amp;:loadOrderID=0"></iframe>');
